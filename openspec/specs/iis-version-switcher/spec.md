# iis-version-switcher Specification

## Purpose

TBD - created by archiving change 'add-iis-switcher'. Update Purpose after archive.
...
<!-- @trace
source: add-iis-switcher
updated: 2026-04-14
code:
  - svn-merge-helper/switch_iis_branch_version.bat
  - svn-merge-helper/src/main/svn-bridge.js
  - svn-merge-helper/src/renderer/js/commit-manager.js
  - svn-merge-helper/test-iis-ver.js
  ...
  - svn-merge-helper/SetSettingFiles.bat
-->
