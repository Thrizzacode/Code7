# jenkins-publish Specification

## Purpose

TBD - created by archiving change 'add-jenkins-publish-page'. Update Purpose after archive.
...
<!-- @trace
source: add-jenkins-publish-page
updated: 2026-09-04
code:
  ...
  - svn-merge-helper/src/main/jenkins-service.js
  - svn-merge-helper/src/renderer/js/settings.js
  - svn-merge-helper/src/renderer/js/publish-manager.js
