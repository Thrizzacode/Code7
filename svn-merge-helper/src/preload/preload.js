...
contextBridge.exposeInMainWorld('svnApi', {
  ...
  mergePreview: (sourceUrl, targetWcPath, revisions) => ipcRenderer.invoke('svn:merge-preview', sourceUrl, targetWcPath, revisions),
  rollbackMerge: (wcPath, addedPaths) => ipcRenderer.invoke('svn:rollback-merge', wcPath, addedPaths),
  ...
  revert: (targetPath, options) => ipcRenderer.invoke('svn:revert', targetPath, options),
